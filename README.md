...
I've used Kustomize extensively over the years and always missed the ability to evaluate environment variables in overlays.
...
# Check the rendered.yaml file is generated in the same folder
```
